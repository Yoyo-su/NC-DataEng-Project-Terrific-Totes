...
class TestJsonDumps:
    @pytest.mark.it("Testing an empty dictionary returns a json string of an empty dictionary")
    def test_empty_dictionary(self):
        test_data = {}
        result = dump_to_json(test_data)
        assert result == json.dumps({})

    @pytest.mark.it("Testing that a nested dictionary returns a json string of a nested dictionary")
