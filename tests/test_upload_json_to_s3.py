...
class TestInsertIntoS3:
    @pytest.mark.it("Testing that our function uploads a complete, simple json file to an s3 bucket.")
    @mock_aws
    ...
    @pytest.mark.it("Test we are storing the json in the right place")
    @mock_aws
